...
/*
    ...
    - 배열[인덱스]로 요소에 접근 가능, 존재하지 않는 인덱스에 접근하면 undefined가 반환됨
...
/*
    - for-in 방식은 index 를 사용하여 한번 더 접근을 해야하기 때문에 
        단순히 읽어들이는 작업만 할 때는 적합하지 않을 수 있음
    - for-of 방식을 사용하여 배열의 요소를 복사하여 직접 사용할 수 있음
*/
